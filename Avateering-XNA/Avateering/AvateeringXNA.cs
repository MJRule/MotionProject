...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class AvateeringXNA : Microsoft.Xna.Framework.Game
    {
        ...
        // @Inputs:		string address, string queue
        // @Outputs:	Boolean
        // 
        // @Desc:		Used to check if the user has
        //			    prefixed 'http://' to the web
        //			    address for connectivity.
        //---------------------------------------------------
        private bool validateAddress(string a, string q)
        {
            string s = "";

            if (a.Equals("") || q.Equals(""))
            {
                MessageBox.Show("Please correctly enter the address and queue information", "Error");
                return false;
            }
            try
            {
        ...
        {
            this.Window.Title = "Senses Places - Avateering v01";
            ...
            do
            {
                address = Interaction.InputBox("Please enter HTTP webserver address including the http:// prefix.\n\nFor example: \"http://virutal.weltec.ac.nz/distance/wi/3Der.php\"", "Senses Places - Avateering v01", "http://127.0.0.1/distance/wi/3Der.php", 0, 0);
                queue = Interaction.InputBox("Please enter a valid queue to retrieve data from.", "Senses Places - Avateering v01", "17", 0, 0);
                setUpCount++;
            } while (!validateAddress(address, queue) && setUpCount < 3);
            ...
            this.fixAvatarHipCenterDrawHeight = false;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            //PeePeeSpeed - Get latest string from queue, set to MData, perform transformations.
            networkModel.getDataFromNetwork();
            ...
            using (var skeletonFrame = frame) 
            {
                ...
                //PeePeeSpeed - set rawSkeleton to fresh skeleton.
